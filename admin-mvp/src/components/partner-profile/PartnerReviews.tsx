...
import { Review } from "@/types/partner-profile";
...
const reviews: Review[] = [
  {
    id: "REV-2024-001",
    rating: 5,
    title: "Perfect coffee shop workspace!",
    comment: "Third Wave Coffee is an amazing place to work. Great coffee, comfortable seating, and excellent WiFi. The day pass was totally worth it!",
    date: "2024-01-15",
  ...
  },
  {
    id: "REV-2024-002",
    rating: 4,
    title: "Great for half-day work sessions",
    comment: "Loved the 6-hour pass at Third Wave Coffee. Perfect for focused work sessions. Coffee quality is outstanding and the atmosphere is very productive.",
    date: "2024-01-12",
  ...
  },
  {
    id: "REV-2024-003",
    rating: 3,
    title: "Decent workspace, could be better",
    comment: "The 3-hour pass was okay. Coffee is good but it gets quite noisy during peak hours. WiFi speed could be improved.",
    date: "2024-01-10",
  ...
  },
  {
    id: "REV-2024-004",
    rating: 5,
    title: "Excellent weekend workspace",
    comment: "The weekend pass at Third Wave Coffee is fantastic! Quieter on weekends, amazing coffee, and great for long work sessions. Highly recommend!",
    date: "2024-01-08",
  ...
  },
  {
    ...
    comment: "Expected better from Third Wave Coffee. The day pass was overpriced and the workspace was too crowded. Coffee was good but not enough to justify the cost.",
    date: "2024-01-05",
    service: "Third Wave Coffee - Day Pass",
...
export default function PartnerReviews({ partnerId }: PartnerReviewsProps) {
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">
              Reviews and ratings for partner&apos;s spaces
            </p>
          </div>
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between pt-2 border-t border-gray-200">
                  <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-4">
                    <div className="text-xs text-gray-500 mt-1">
                      Service: {review.service} • Customer: {review.customer}
                    </div>
                  </div>
