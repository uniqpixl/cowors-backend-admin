...
import { ActivityLogEntry } from "@/types/partner-profile";

const PartnerActivityLogContent: React.FC = () => {
  const activities: ActivityLogEntry[] = [
    {
      id: "ACT-2024-001",
      type: "security",
      action: "login",
      description: "Partner successfully logged in to the platform",
    ...
    },
    {
      ...
      type: "booking",
      action: "space_booked",
      description: "Private office space was booked by a customer",
    ...
    },
    {
      ...
      description: "Monthly payout processed for partner earnings",
    ...
    },
    {
      ...
      type: "profile",
      action: "space_update",
      description: "Updated space information and amenities",
    ...
    },
    {
      ...
      type: "security",
      action: "logout",
      description: "Partner logged out from the platform",
    ...
    },
    {
      ...
      type: "system",
      action: "notification",
      description: "System notification sent for booking confirmation",
    ...
    },
    {
      ...
      description: "Platform commission deducted from booking #BK-2024-002",
      timestamp: "2024-01-11T13:20:00Z",
      status: "success",
      ipAddress: "N/A",
      device: "System",
      location: "N/A",
      resourceId: "COM-2024-001"
    }
  ];
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <p className="text-sm text-gray-500">
            Complete partner activity history and system events
          </p>
        </div>
      ...
      {activities.length === 0 && (
        <div className="text-center py-8">
          <p className="text-gray-500">
            No activity logs found for this partner.
          </p>
        </div>
      )}
    </div>
...
export default PartnerActivityLogContent;